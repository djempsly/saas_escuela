...
// GET /sabana/:cicloLectivoId/exportar-todo - Exportar TODAS las sábanas (una hoja por nivel)
router.get(
  '/:cicloLectivoId/exportar-todo',
  roleMiddleware([ROLES.DIRECTOR, ROLES.COORDINADOR, ROLES.COORDINADOR_ACADEMICO]),
  exportarTodoHandler,
);
