/**
 * Template de Boletín para Primaria - Haití
...
/**
 * Template placeholder para Primaria Haití
 */
export class PrimariaHtTemplate extends BaseBoletinTemplate {
  ...
  getMetadata(): TemplateMetadata {
    return {
      sistemaEducativo: 'PRIMARIA_HT',
      nombre: 'Bulletin Scolaire - Primaire',
      descripcion: 'Format pour l\'école primaire - En développement',
      ...
      <Document>
        <Page size="A4" style={styles.page}>
          <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>École Primaire - Haïti</Text>
...
registerTemplate('PRIMARIA_HT', PrimariaHtTemplate);

export default PrimariaHtTemplate;
